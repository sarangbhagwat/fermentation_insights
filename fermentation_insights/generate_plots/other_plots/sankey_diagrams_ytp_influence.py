...
fermentation = bst.System.from_units('fermentation', unit_groups_dict['fermentation'].units)
...
#%% Sankey diagrams
x = np.array([0.15, 0.28, 0.4, 0.6, 0.68, 0.8, 0.9, 0.9])
y = [0.15, 0.15, 0.2, 0.4, 0.8, 0.2, 0.2, 0.8]
...
#%%
s, t, v, l = get_mass_flow_by_area(flow_nodes=[feedstock_acquisition,
                           feedstock_juicing,
                           fermentation,
                           separation,
                           catalytic_upgrading,
