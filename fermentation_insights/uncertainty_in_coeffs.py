...
import pickle
import os
from fermentation_insights.utils import fit_shifted_rect_hyperbola_two_param
...
N_simulations_per_TRY_combo = 1000 # 6000
...
#%%
print([np.median(i) for i in [a, b, c, d, g]])
print([np.percentile(i, 5) for i in [a, b, c, d, g]])
print([np.percentile(i, 95) for i in [a, b, c, d, g]])
